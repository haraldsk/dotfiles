...
return {
  ...
  cmd = {
    ...
    '-jar', vim.fn.glob(vim.stdpath('data') .. '/mason/plugins/org.eclipse.equinox.launcher_*.jar'),
    ...
    '-configuration', vim.stdpath('data') .. '/mason/packages/jdtls/config_mac_arm/config.ini',
